...
class NanoBanana2API:
    ...
    def generate_image(self, prompt: str, aspectRatio: str = "9:16", resolution: str = "2K", outputFormat: str = "png"):
        payload = {
...
Professional mobile game App Store screenshot quality."""
    ...
    summary = {
        "batchId": f"chsx_store_five_{timestamp}",
        "project": "插花三消商店五图",
        "client": "权哥",
        "timestamp": timestamp,
    ...
    for r in results:
        ...
        print(f"{status_icon} {r['seq']}. {r['title']} ({r.get('banner', 'N/A')})")
